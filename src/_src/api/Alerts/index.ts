...
import {
  ...
  IDeleteAlertParams, IDoMatchActionParams,
  IGetAlertParams,
  IGetAlertTreeParams,
...
export class AlertsAPI extends Request {
  ...
  public CreateAlertFolder(params: ICreateAlertFolderParams) {
    return this
      .handle()
      .request<CreateAlertFolderResponse>({
  ...
  public UpdateAlertFolder(params: IUpdateAlertFolderParams) {
    return this
      .handle()
      .request<UpdateAlertFolderResponse>({
  ...
  public GetMatchActions(params: IGetMatchActionsParams) {
    return this
      .handle()
      .request<GetMatchActionsResponse>({
