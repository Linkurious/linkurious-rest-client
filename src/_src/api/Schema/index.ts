...
import {
  ...
  ICreateTypeParams,
  ICreateTypeResponse, IGetNonIndexedPropertiesParams, IGetNonIndexedPropertiesResponse,
  IGetSamplingStatusParams,
  IGetSamplingStatusResponse, IGetSimpleSchemaParams, IGetSimpleSchemaResponse,
  IGetTypesParams,
  IGetTypesResponse,
  IGetTypesWithAccessParams,
  IGetTypesWithAccessResponse, ISetNonIndexedPropertiesParams,
...
const {UNAUTHORIZED, FORBIDDEN, NOT_FOUND, DATA_SOURCE_UNAVAILABLE} = LkErrorKey;

export class SchemaApi extends Request {
  public async startSchemaSampling(params: IStartSchemaSamplingParams){
    return this.handle(UNAUTHORIZED, FORBIDDEN, DATA_SOURCE_UNAVAILABLE)
      .request({
  ...
  public async getSamplingStatus(params?: IGetSamplingStatusParams){
    return this.handle(UNAUTHORIZED, FORBIDDEN, DATA_SOURCE_UNAVAILABLE)
      .request<IGetSamplingStatusResponse>({
  ...
  public async createType(params: ICreateTypeParams) {
    return this.handle(UNAUTHORIZED, FORBIDDEN)
      .request<ICreateTypeResponse>({
  ...
  public async updateType(params: IUpdateTypeParams) {
    return this
      .handle(UNAUTHORIZED, FORBIDDEN, NOT_FOUND)
      .request({
        url: '/admin/:sourceKey/graph/schema/:entityType/types',
        method: 'PATCH',
        params: params
  ...
  public async createProperty(params: ICreatePropertyParams) {
    return this
      .handle(UNAUTHORIZED, FORBIDDEN, NOT_FOUND)
      .request<ICreatePropertyResponse>({
  ...
  public async updateSchemaSettings(params: IUpdateSchemaSettingsParams){
    return this
      .handle(UNAUTHORIZED, FORBIDDEN, DATA_SOURCE_UNAVAILABLE)
      .request({
  ...
  public async getTypesWithAccess(params: IGetTypesWithAccessParams) {
    return this
      .handle(UNAUTHORIZED, FORBIDDEN, DATA_SOURCE_UNAVAILABLE)
      .request<IGetTypesWithAccessResponse>({
  ...
  public async getSimpleSchema(params?: IGetSimpleSchemaParams) {
    return this
      .handle(UNAUTHORIZED, FORBIDDEN, DATA_SOURCE_UNAVAILABLE)
      .request<IGetSimpleSchemaResponse> ({
  ...
  public getNonIndexedEdgeProperties(params?: IGetNonIndexedPropertiesParams) {
    return this
      .handle(UNAUTHORIZED, FORBIDDEN, DATA_SOURCE_UNAVAILABLE)
      .request<IGetNonIndexedPropertiesResponse>({
