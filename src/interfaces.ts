...
export namespace LKClient {
  ...
  export interface Interface {
    ...
    requestGraphWithQuery(data:Query.form.request):Promise<Array<Node.model>>;
    ...
    getSourceConfig(sourceIndex?:number):Promise<App.config>;
    updateConfiguration(data:App.form.update):Promise<string>;
    ...
    getEdgeTypesProperties(params?:Schema.request.properties):Promise<Schema.propertyList>;
    getNodeTypesProperties(params?:Schema.request.properties):Promise<Schema.propertyList>;
    ...
    searchItems(item:Item, params:Schema.request.itemsList):Promise<Schema.itemsList>;
    searchFullItems(item:Item, params:Schema.request.itemsList):Promise<Array<Node.model>>;
    searchDirectory(data:Directory.request.list):Promise<Directory.list>;
    connectDataSource(sourceIndex:number):Promise<boolean>;
    configureDataSource(data:Source.form.create):Promise<boolean>;
    deleteDataSource(sourceIndex:number):Promise<boolean>;
    deleteDatas(data:Source.form.Delete):Promise<Source.deletedDatas>;
    getAllDataSOurces():Promise<Array<Source.adminModel>>;
    ...
    getAllGroups(dataSource?:string):Promise<Array<Group.model>>;
    getGroupRight(dataSource ?:string):Promise<Group.sourceAccessRights>;
    ...
    createViz(data:Visualization.form.create):Promise<Visualization.model>;
    deleteWidget(widgetKey:string):Promise<string>;
    deleteFolder(folderId:number):Promise<string>;
    duplicateViz(vizId:number):Promise<Visualization.model>;
    getWidget(widgetKey:string):Promise<Visualization.widget>;
    getVizSandbox(params:Visualization.request.sandbox):Promise<Visualization.model>;
    getViz(vizId:number):Promise<Visualization.model>;
    getVizTree():Promise<Visualization.tree>;
    deleteViz(vizId:number):Promise<string>;
    getVizSharer(vizId:number):Promise<Visualization.shareInfos>;
    shareViz(data:Visualization.form.setShareRights):Promise<Visualization.shareRights>;
    unshareViz(data:Visualization.form.setShareRights):Promise<string>;
    updateFolder(folderId:number, data:Visualization.form.updateFolder):Promise<boolean>;
    updateVizSandbox(data:Visualization.form.updateSandbox):Promise<boolean>;
    updateViz(vizId:number, data:Visualization.form.update):Promise<boolean>;
  }
}
