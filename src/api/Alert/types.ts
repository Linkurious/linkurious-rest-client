...
export interface AlertQueryError extends AlertError {
  queryId: number;
}

export interface AlertPreprocessingStepError extends AlertError {
  query: string;
}

export interface AlertCaseAttributeQueryError extends AlertError {}
