...
export interface NodeGroupingRule<Type extends NodeGroupingType = never> {
  id: number;
  uuid: string;
  sourceKey: string;
  name: string;
  groupingType: Type extends never ? NodeGroupingType : Type;
  groupingOptions: Type extends never
